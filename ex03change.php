            ...
            <div class="wrap">
                ...
                if($_SESSION['id'] != null)
                {
                    ...
                    while($row = mysqli_fetch_row($result)) {
                        echo "<form name=\"form\" method=\"post\" action='ex03change_finish.php'>";
                        echo "<b>position：</b><input type=\"text\" name=\"paper\" value=\"$row[0]\" /> <br>";
                        echo "<b>style：</b><input type=\"text\" name=\"style\" value=\"$row[2]\" /> <br>";
